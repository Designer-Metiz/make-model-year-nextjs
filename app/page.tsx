    ...
    '@graph': [
      ...
      },
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'What is MSPL Make Model Year?',
            acceptedAnswer: {
              '@type': 'Answer',
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes, MSPL Make Model Year works with all the latest Shopify themes and integrates seamlessly with your store design.',
            },
          },
          {
            '@type': 'Question',
